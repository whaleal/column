...
public interface ColumnEditor {
    ...
    /**
     * Get the represent {@link JdbcType JDBC type} for this column
     *
     ...
     * @return this editor so callers can chain methods together
     */
    ColumnEditor representType(JdbcType jdbcType);
     ...
     * @return a type constant for the specific database
     */
    ColumnEditor nativeType(JdbcType nativeType);
